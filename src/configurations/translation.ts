export const frTranslation = {
  ...
  EMAIL_PASSWORD_SIGN_IN_FOOTER_FORGOT_PW_LINK: "Mot de passe oublier?",

  EMAIL_PASSWORD_SIGN_IN_WRONG_CREDENTIALS_ERROR:
    "Mot de passe ou email incorrect",

  EMAIL_PASSWORD_RESET_HEADER_TITLE: "Réinitialiser le compte",
  EMAIL_PASSWORD_RESET_HEADER_SUBTITLE:
    "Nous allons vous envoyer un email pour réstaurer votre mot de passe.",
  ...
  EMAIL_PASSWORD_RESET_RESEND_LINK: "Renvoyer ou modifier l'e-mail",
  EMAIL_PASSWORD_RESET_SEND_BTN: "Envoyez moi un email",
  EMAIL_PASSWORD_RESET_SIGN_IN_LINK: "S'identifier",

  ERROR_EMAIL_INVALID: "L'email est invalide",
  SOMETHING_WENT_WRONG_ERROR:
    "Quelque chose s'est mal passé. Veuillez réessayer.",

  EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_TITLE: "Changer de mot de passe",
  EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_SUBTITLE:
    "Entrez un nouveau mot de passe ci-dessous pour changer le votre",
  EMAIL_PASSWORD_RESET_SUBMIT_PW_CHANGE_PW_BTN: "CHANGER MON MOT DE PASSE",
  EMAIL_PASSWORD_RESET_PASSWORD_INVALID_TOKEN_ERROR:
    "Jeton de réinitialisation de mot de passe invalide",

  EMAIL_PASSWORD_NEW_PASSWORD_LABEL: "Nouveau mot de passe",
  EMAIL_PASSWORD_NEW_PASSWORD_PLACEHOLDER: "Nouveau mot de passe",
  EMAIL_PASSWORD_CONFIRM_PASSWORD_LABEL: "Confirmez le mot de passe",
  EMAIL_PASSWORD_CONFIRM_PASSWORD_PLACEHOLDER: "Confirmez votre mot de passe",

  ERROR_PASSWORD_NON_STRING:
    "Le mot de passe doit être de type chaîne de caractères",
  ERROR_PASSWORD_TOO_SHORT:
    "Le mot de passe doit contenir au moins 8 caractères, dont un chiffre",
  ERROR_PASSWORD_TOO_LONG:
    "La longueur du mot de passe doit être inférieure à 100 caractères",
  ERROR_PASSWORD_NO_ALPHA: "Le mot de passe doit contenir au moins un alphabet",
  ERROR_PASSWORD_NO_NUM: "le mot de passe doit contenir au moins un chiffre",
  ERROR_CONFIRM_PASSWORD_NO_MATCH:
    "Le mot de passe de confirmation ne correspond pas",

  ERROR_NON_OPTIONAL: "Le champ n'est pas facultatif",

  EMAIL_PASSWORD_RESET_SUBMIT_PW_SUCCESS_HEADER_TITLE: "Succès!",
